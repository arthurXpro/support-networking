...
import { Calendar, MapPin, Phone, Mail, Clock, Tag, DollarSign, CheckCircle, Users } from 'lucide-react';
...
const serviceData = {
  ...
  description: 'خدمة جلسات العلاج الفيزيائي للأطفال من ذوي الاحتياجات الخاصة. تهدف الجلسات إلى تحسين القدرات الحركية وتعزيز الاستقلالية في الحركة والتنقل. يشرف على الجلسات فريق متخصص من أخصائيي العلاج الفيزيائي المؤهلين للتعامل مع احتياجات الأطفال المختلفة.',
  association: {
    id: '1',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'نعم، يجب حضور ولي الأمر أو المعيل مع الطفل لمتابعة الجلسة والتعرف على التمارين التي يمكن متابعتها في المنزل.'
    }
  ],
  reviews: [
    {
      ...
      rating: 5,
      date: '15/03/2025',
      comment: 'خدمة ممتازة والفريق متعاون جداً. تحسنت حالة ابني كثيراً بعد جلستين فقط.'
    },
    {
      id: 2,
      user: 'سمر علي',
...
const ServicePage = () => {
  ...
  const service = serviceData; // In a real app, this would be fetched from API
            ...
            <div>
              <div className="text-sm breadcrumbs">
                <ul className="flex items-center space-x-2 space-x-reverse">
                  ...
                  <li><Link to="/services" className="text-gray-500 hover:text-primary">الخدمات</Link></li>
                  <li><span className="mx-2 text-gray-400">/</span></li>
              ...
              <div className="flex items-center mt-2">
                <Link to={`/associations/${service.association.id}`} className="text-primary hover:underline">
                ...
                <div className="flex items-center mr-2">
                  ...
                  <span className="text-gray-500 text-sm">({service.association.reviewsCount} تقييم)</span>
                </div>
              </div>
            </div>
            <Button 
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="absolute bottom-4 right-4 flex space-x-2 space-x-reverse">
                  {service.images.map((_, index) => (
                    <button 
                      ...
                      className={`w-3 h-3 rounded-full ${index === currentImage ? 'bg-primary' : 'bg-white'}`}
                    ></button>
                  ))}
                </div>
                <button 
                ...
                <Tabs defaultValue="details">
                  ...
                  <TabsContent value="details" className="mt-4">
                    <div className="space-y-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold mb-2">أسئلة شائعة</h3>
                  ...
                  <TabsContent value="requirements" className="mt-4">
                    <div className="space-y-4">
                      <div>
                        <h3 className="text-lg font-semibold mb-2">متطلبات الخدمة</h3>
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
                        ...
                        <p className="text-yellow-700 mt-1">
                          يرجى إحضار جميع المستندات المطلوبة وقت الزيارة للاستفادة من الخدمة بشكل سريع.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="reviews" className="mt-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold">تقييمات المستفيدين</h3>
                        <div className="flex items-center">
                          <div className="text-2xl font-bold text-yellow-500 ml-2">{service.association.rating}</div>
                          <div className="flex">
                            {renderStars(service.association.rating)}
                          </div>
                        </div>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <span className="text-gray-500 text-sm">عدد المستفيدين</span>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-4">معلومات مزود الخدمة</h3>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <Link to={`/associations/${service.association.id}`} className="font-medium text-primary hover:underline">
                      {service.association.name}
                    </Link>
                    <div className="flex items-center mt-1">
                      ...
                      <span className="text-gray-500 text-sm mr-1">({service.association.reviewsCount})</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">خدمات مشابهة قد تهمك</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Placeholder for similar services */}
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="h-48 overflow-hidden">
                <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6" className="w-full h-full object-cover" alt="خدمة مشابهة" />
              </div>
              <div className="p-4">
                <Badge variant="outline" className="mb-2">طبية</Badge>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="h-48 overflow-hidden">
                <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158" className="w-full h-full object-cover" alt="خدمة مشابهة" />
              </div>
              <div className="p-4">
                <Badge variant="outline" className="mb-2">تعليمية</Badge>
                <h3 className="font-semibold text-lg">دورة تعليمية للأطفال</h3>
                <p className="text-gray-500 text-sm mb-3">جمعية الأمل للمستقبل</p>
                <Button variant="outline" size="sm" className="w-full">عرض التفاصيل</Button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="h-48 overflow-hidden">
                <img src="https://images.unsplash.com/photo-1488590528505-98d2b5aba04b" className="w-full h-full object-cover" alt="خدمة مشابهة" />
              </div>
              <div className="p-4">
                <Badge variant="outline" className="mb-2">نفسية</Badge>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">أوقات العمل: {service.hours}</p>
            </div>
