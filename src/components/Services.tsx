    ...
    <section className="py-16 md:py-24 bg-white" id="services">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">نقدم حلولاً متكاملة لذوي الاحتياجات الخاصة</h2>
          <p className="text-gray-600 text-lg">
            نسعى لتوفير مجموعة شاملة من الخدمات المتخصصة التي تلبي احتياجات الأفراد وأسرهم بجودة عالية وبطريقة ميسرة.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesData.map((service) => (
            ...
            >
              <div className={`flex items-center justify-center w-14 h-14 rounded-lg mb-6 bg-gradient-to-r ${service.color} transform group-hover:scale-110 transition-all duration-300`}>
                {service.icon}
              </div>
