...
const steps = [
  {
    ...
    description: "استخدم خيارات البحث المتقدمة لإيجاد الخدمة المناسبة حسب نوع الإعاقة، الموقع، أو نوع الخدمة.",
  ...
  },
  {
    ...
    description: "تواصل مباشرة مع الجمعية المتخصصة لمناقشة التفاصيل والإجابة عن استفساراتك.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg">
            صممنا المنصة لتكون سهلة الاستخدام وتتيح لك الوصول إلى الخدمات المناسبة بأقل جهد وأسرع وقت.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            {steps.map((step, index) => (
              <div key={step.id} className="flex flex-col items-center text-center">
                <div className={`mb-6 w-20 h-20 flex items-center justify-center rounded-full bg-gradient-to-r ${step.color} shadow-lg`}>
                  {step.icon}
