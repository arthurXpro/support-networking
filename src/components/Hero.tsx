    ...
    <div className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-24 bg-gradient-to-br from-secondary to-blue-50">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-right order-2 lg:order-1 animate-fade-in" style={{ direction: 'rtl' }}>
            ...
            <h1 className="hero-text text-gray-900 mb-6">
              نسهل وصولك للخدمات
              <span className="text-primary block mt-2">بكل سهولة وموثوقية</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8 max-w-xl">
              منصة إلكترونية شاملة تهدف إلى تسهيل وصول ذوي الاحتياجات الخاصة وأسرهم إلى الخدمات الأساسية عن طريق ربطهم مع الجمعيات المتخصصة، مع ضمان جودة الخدمات عبر آلية تحكم آمنة.
            </p>
            <div className="flex flex-wrap gap-4 justify-start">
              <Link to="/services" className="flex items-center gap-2 py-3 px-8 rounded-full bg-primary text-white hover:bg-primary/90 transition-all duration-300 shadow-lg shadow-primary/20">
                <span>استكشف الخدمات</span>
                <ArrowRight size={18} />
              </Link>
              <Link to="/associations" className="py-3 px-8 rounded-full border border-primary text-primary hover:bg-secondary transition-all duration-300">
                الجمعيات المتخصصة
              </Link>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 glass-card p-4 rounded-lg shadow-lg max-w-xs animate-float">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-sm font-medium">خدمات متخصصة على مدار 24 ساعة</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <p className="text-sm font-medium">أكثر من 500+ جمعية متخصصة</p>
                </div>
              </div>
            </div>
          </div>
